...
///  - A [Supplier] function to convert the bean to a `Node`. This is useful for example in case you want to implement
///  a view switcher, you could produce a `Button` or any node you want that will handle the view switching,
///  for a concrete example you could see the MaterialFX's DemoController (in the demo module).
///
/// The bean also offers a [Builder] with fluent api, it's suggested to use that instead of constructors.
///
...
public class MFXLoaderBean {
    ...
    /// @return the supplier used to convert this view into a `Node`
