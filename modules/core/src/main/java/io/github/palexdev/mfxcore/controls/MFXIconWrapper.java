...
public class MFXIconWrapper extends StackPane {
	...
	public MFXIconWrapper defaultRippleGeneratorBehavior() {
		addRippleGenerator();
		rippleGenerator.setRipplePositionFunction(event -> Position.of(event.getX(), event.getY()));
	 ...
	 * @see MFXCircleRippleGenerator
	 */
	public MFXIconWrapper rippleGeneratorBehavior(Function<MouseEvent, Position> positionFunction) {
		addRippleGenerator();
