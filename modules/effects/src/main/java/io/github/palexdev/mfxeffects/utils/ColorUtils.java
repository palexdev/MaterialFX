...
public class ColorUtils {
    ...
    ///
    /// This is partly a copy of [#toString()] but `Stops` are correctly converted for CSS.
    ///
    ...
    /// Properly converts a [Stop] to string. Partly copied from [#toString()] but the color is converted using [#rgba(Color)].
