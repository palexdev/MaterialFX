...
/// Extension of [Transition] to make some methods use fluent API.
public abstract class FluentTransition extends Transition {
    ...
    /// Sets the transition's interpolator to one provided by [Interpolators].
    ...
    /// between 'end' and 'stop', see [Animations#onStatus(Animation, Status, Runnable, boolean)].
