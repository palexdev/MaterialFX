...
public class SynchronizedBooleanProperty extends SimpleBooleanProperty implements SynchronizedProperty<Boolean> {
    ...
    protected final BindingManager<Boolean> bindingManager = new BindingManager<>();
    ...
    private void initialize() {
        ...
        provideHelperFactory(property -> new BindingHelper<>() {
            @Override protected void updateBound(Boolean newValue) {
                set(newValue);
            }
        });
        provideBidirectionalHelperFactory((property) -> new BidirectionalBindingHelper<>(property) {
            @Override protected void updateThis(Boolean newValue) { set(newValue); }
            @Override protected void updateOther(Property<Boolean> other, Boolean newValue) { other.setValue(newValue); }
        });
     ...
     */
    @Override
    public void provideHelperFactory(Function<ObservableValue<? extends Boolean>, BindingHelper<Boolean>> factory) {
     ...
     */
    @Override
    public void provideBidirectionalHelperFactory(Function<Property<Boolean>, BidirectionalBindingHelper<Boolean>> factory) {
