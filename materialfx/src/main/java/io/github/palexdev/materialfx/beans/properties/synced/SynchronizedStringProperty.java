...
public class SynchronizedStringProperty extends SimpleStringProperty implements SynchronizedProperty<String> {
    ...
    protected final BindingManager<String> bindingManager = new BindingManager<>();
    ...
    private void initialize() {
        ...
        provideHelperFactory(property -> new BindingHelper<>() {
            @Override protected void updateBound(String newValue) {
                set(newValue);
            }
        });
        provideBidirectionalHelperFactory((property) -> new BidirectionalBindingHelper<>(property) {
            @Override protected void updateThis(String newValue) {
                set(newValue);
            }
            @Override protected void updateOther(Property<String> other, String newValue) { other.setValue(newValue); }
        });
    }
     ...
     */
    @Override
    public void provideHelperFactory(Function<ObservableValue<? extends String>, BindingHelper<String>> factory) {
     ...
     */
    @Override
    public void provideBidirectionalHelperFactory(Function<Property<String>, BidirectionalBindingHelper<String>> factory) {
