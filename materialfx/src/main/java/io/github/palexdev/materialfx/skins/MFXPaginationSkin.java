...
public class MFXPaginationSkin extends SkinBase<MFXPagination> {
    ...
    public MFXPaginationSkin(MFXPagination pagination) {
        ...
        leftArrow = new MFXIconWrapper("fas-chevron-left", 12, 32).defaultRippleGeneratorBehavior();
        rightArrow = new MFXIconWrapper("fas-chevron-right", 12, 32).defaultRippleGeneratorBehavior();
