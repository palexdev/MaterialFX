...
public class MFXSlider extends Control implements Themable {
    ...
    protected void defaultThumbSupplier() {
        setThumbSupplier(() -> {
            MFXFontIcon thumb = new MFXFontIcon("fas-circle", 12);
            MFXFontIcon thumbRadius = new MFXFontIcon("fas-circle", 30);
    ...
    protected void defaultPopupSupplier() {
        setPopupSupplier(() -> {
            ...
            MFXFontIcon caret = new MFXFontIcon("fas-caret-down", 22);
